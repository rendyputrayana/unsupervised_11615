...
def scatter(model, model_name, data, new_point, features, color_scale, title):
    ...
    fig = px.scatter_3d(data, x='Avg_Credit_Limit', y='Total_Credit_Cards',z='Total_visits_online',color=f"{model_name}_Cluster",color_continuous_scale=color_scale,title=title)
...
st.set_page_config(
    page_title="11615 - Unsupservised Learning",
    page_icon="📊",
    layout='wide',
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'> UnsupervisedLearning - 11615</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'C:\Users\ASUS\Downloads\Unsupervised Learning (Praktek)\Unsupervised Learning (Praktek)\Tugas4_X_YYYYY'
    model_path = {
